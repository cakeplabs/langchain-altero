...
class NLTKBM25Retriever(BaseRetriever):
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        """
        Create a NLTKBM25Retriever from a list of texts.
        Args:
    ...
    def from_documents(
        ...
        **kwargs: Any,
        ...
        """
        Create a NLTKBM25Retriever from a list of Documents.
        Args:
